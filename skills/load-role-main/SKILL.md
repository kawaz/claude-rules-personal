...
6. `~/.local/share/repos/github.com/kawaz/claude-rules-personal/main/reference/_index.md` と同 `memory/_index.md` を **Read する** (skill ではなくファイル。参照知識の索引を context に持ち、本文は必要時にその 1 ファイルだけ Read する)
